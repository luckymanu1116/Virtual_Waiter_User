 ...
 */
public class StartersitemSelect extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_startersitem_select, container, false);
        ...
        //sorg=Long.valueOf((price.getText()).toString());
